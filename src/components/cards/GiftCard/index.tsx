...
const glowGradientMap: Record<GiftCardVariant, string> = {
  ...
  green:
    "bg-[linear-gradient(90deg, #C2E8FD -0.05%, #67E0AC 31.2%, #138B57 75.92%, #C2E8FD 100.02%)]",
  silver:
...
const GiftCard = ({
  ...
  return (
    <div
      className={cn(
        "bg-primitives-white_5 relative flex w-full flex-col overflow-hidden rounded-[42px] p-2 sm:p-1",
        className,
      )}
    >
      <div
        className={cn(
          "absolute -top-11 left-1/2 h-[137px] w-[276px] -translate-x-1/2 rounded-[276px] opacity-[0.5] blur-[68.05000305175781px]",
